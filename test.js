...
//create a new document of the model -> (Doc Object, Callback)
// BlogPost.create({
...
// BlogPost.findById('61594e0eea0bf2b7ea97b4b8', (error, blogpost) => {
//     console.log(error, blogpost)
// })

BlogPost.findByIdAndUpdate('61594e0eea0bf2b7ea97b4b8', {
    title: 'Islam Loves Alaa'
}, (error, blogpost) => {
    console.log(error, blogpost)
})